...
CHANNEL_USERNAME = os.getenv('CHANNEL_USERNAME', '@SHAITaN_KA_BAAP_Hu')
OWNER_URL = os.getenv('OWNER_URL', 'https://t.me/SHAITaN_KA_BAAP_Hu')
WORKERS = int(os.getenv('WORKERS', '16'))
OWNER_ID_1 = int(os.getenv('OWNER_ID_1', '5663291046'))
OWNER_ID_2 = int(os.getenv('OWNER_ID_2', '5663291046'))
...
bot = telebot.TeleBot(8214030670:AAFHyG47OtE0CAvLJYJ3naoZN8W8Jn-C6bU, num_threads=WORKERS)
